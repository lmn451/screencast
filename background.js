(() => {
  ...
  // logger.js
  // In MV3, content_security_policy is an object like { extension_pages: "..." }
  var manifestCSP = chrome.runtime?.getManifest?.()?.content_security_policy;
  var cspString = typeof manifestCSP === 'string' ? manifestCSP : typeof manifestCSP === 'object' && manifestCSP !== null ? manifestCSP['extension_pages'] || '' : '';
  var isDev = cspString.includes('unsafe-eval') === true;
